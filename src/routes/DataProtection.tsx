...
export const DataProtection = () => {
    return (
        <div className="container">
            <PageTitle title="Datenschutzerklärung"></PageTitle>
            ...
            <p>
                Winitiative Augsburg e.V.
                <br />
                <br />
                Gustav-Heinemann-Straße 9 1/4 86199 Augsburg
            </p>
            ...
            <p>
                Bei der Benutzung des Kontaktformulars werden die von Ihnen
                übermittelten Daten vom externen Anbieter formsubmit.co
                verarbeitet und unterliegen dessen Datenschutzerklärung.
                formsubmit.co übermittelt die Daten an
                fritz.duerrwanger@winitiative-augsburg.de. Weitere Informationen
                und Widerspruchsmöglichkeiten finden sich in der
                Datenschutzerklärung von formsubmit.co:
                https://formsubmit.co/privacy.pdf Wenn Sie uns ohne Verwendung
                dieser Drittanbieter kontaktieren wollen, können Sie uns eine
                Email an fritz.duerrwanger@winitiative-augsburg.de schreiben.
            </p>
        </div>
    );
};
