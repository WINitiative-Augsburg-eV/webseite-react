    ...
    return (
        <div>
            ...
            <div className="container">
                Winitiative e.V.
                <br /> Gustav-Heinemann-Straße 9 1/4 86199 Augsburg
                <br />
                leonhard.weng@winitiative-augsburg.de
                <br /> <br />
                Registereintrag: Eingetragen im Vereinsregister
                <br /> Registergericht: Amtsgericht Augsburg
                <br />
                Registernummer: 201972
                <br />
                <br /> Vertreten durch: Leonhard Weng (1. Vorstand)
                <h3 className="my-4">Disclaimer - rechtliche Hinweise</h3>
                <h3 className="my-4">Auskunfts- und Widerrufsrecht</h3>
                ...
                Ihrer angegebenen persönlichen Daten mit Wirkung für die Zukunft
                widerrufen. Hierfür wenden Sie sich bitte an den im Impressum
                angegebenen Diensteanbieter.
                <h3 className="my-4">Disclaimer (Haftungsausschluss)</h3>
                <ul>
                    <li>
                        1. Haftung für Inhalte Als Diensteanbieter sind wir
                    ...
                    <li>
                        2. Haftung für Links Diese Website enthält Links zu
                        externen Webseiten Dritter, auf deren Inhalte kein
                        Einfluss genommen werden kann. Deshalb kann für diese
                        fremden Inhalte auch keine Gewähr übernommen werden. Für
                        die Inhalte der verlinkten Seiten ist stets der
                        ...
                        Links umgehend von dieser Website auf die
                        rechtsverletzende Site entfernen.
                    </li>
                    <li>
                        3. Urheberrecht Die durch die Diensteanbieter, deren
                        Mitarbeiter und beauftragte Dritte erstellten Inhalte
                        ...
                        Grenzen des Urheberrechtes bedürfen der vorherigen
